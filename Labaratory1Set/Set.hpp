...
public:
	Field Is;
	bool IsField; //решил выделить это в public, потому что посчитал
	//, что пользователь/программист должен в открытую получать информацию о том, что Поле это или нет
